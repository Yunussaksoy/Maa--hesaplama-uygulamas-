...
root.configure(bg="GREEN")#PENCERE RENGİ
root.geometry("900x800")#PENCERE BOYUT
    ...
    if username == "123":
        if passaword == "123":
            ...
            if group == 1:
                ...
                print("TEMİLİK GÖREVLİSİ BİRİMİNİ SEÇTİNİZ")
                print("-------------------------------------------")
        ...
        print("HATALI GİRİŞ")
Label(root, text="", bg="dark blue", height="2").pack()
Label(root, text=" MAAŞ HESAPLAMA SİSTEMİ", background="white", font="verdana 40 ").pack()#PENCERE ANA BAŞLIK
#KULLANICIYI  YÖNLENDİREN  GÖREVİ OLMAYAN TERİMLER
departman=Label(root,text="---------------------------DEPARTMANLAR---------------------------").place(x=200,y=130)
departman1=Label(root,text="1)YÖNETİCİ ").place(x=290,y=160)
departman2=Label(root,text="2)YÖNETİCİ ASİSTANI").place(x=290,y=190)
departman3=Label(root,text="3)TEKNİK PERSONEL").place(x=290,y=220)
departman4=Label(root,text="4)PROJE YÖNETİCİSİ").place(x=290,y=250)
departman5=Label(root,text="5)PROJE YÜRÜTÜCÜSÜ").place(x=290,y=280)
username=Label(root,text="KULLANICI ADINIZI GİRİNİZ :").place(x=80,y=320)
passwordname=Label(root,text="KULLANICI ŞİFRENİZİ GİRİNİZ :").place(x=80,y=350)
departmanchoice=Label(root,text=" DEPARTMANI SEÇİNİZ :").place(x=80,y=380)
personel_name=Label(root,text="PERSONEL İSMİ GİRİNİZ :").place(x=80,y=410)
personel_dailynetsalary=Label(text="ÇALIŞILAN TOPLAM GÜN SAYISI :").place(x=80,y=440)
overtimepersonel=Label(root,text="YAPTIĞI EK MESAİ VARSA GİRİNİZ").place(x=80,y=470)
...
#--------------------------------------------------------------------------------------------------------------
loginButton =tkinter.Button(root,text="HESAPLA",bg="dark orange",fg="GREEN",command=hesapişmaaş)#HESAPLAMA FONKSİYONU
loginButton.place(x=350,y=500)
